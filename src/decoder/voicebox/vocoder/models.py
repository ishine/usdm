...
# https://huggingface.co/nvidia/bigvgan_22khz_80band/blob/main/bigvgan.py
class BigVGAN(
    torch.nn.Module,
    ...
    # this is main BigVGAN model. Applies anti-aliased periodic activation for resblocks.
